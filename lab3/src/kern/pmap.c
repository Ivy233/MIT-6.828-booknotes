...
i386_detect_memory(void)
{
	...
	cprintf("basemem = %x, extmem = %x, ext16mem = %x\n", basemem, extmem, ext16mem);
	cprintf("totalmem = %x, npages = %x, npages_basemem = %x\n", totalmem, npages, npages_basemem);
...
mem_init(void)
{
	...
	// Your code goes here:
	// CPU0使用的栈，栈的大小已经给出来了。
	// 因为多CPU系统的存在，如果某CPU的占空间一不小心进入了其他的空间
	// 就会报错
